...
int playCard_Baron(struct gameState* state, int currentPlayer, int choice1)
{
	// increase buys by 1
	//state->numBuys++;
...
int playCard_Minion(struct gameState* state, int currentPlayer, int choice1, int choice2, int handPos)
{
	int i, j;
	//+1 action
	//state->numActions++;
...
int playCard_Tribute(struct gameState* state, int currentPlayer, int nextPlayer, int choice1, int choice2, int handPos)
{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        playCard_Mine(state, handPos, currentPlayer, choice1, choice2);
    ...
    case baron:
        return playCard_Baron(state, currentPlayer, choice1);
    ...
    case minion:
		playCard_Minion(state, currentPlayer, choice1, choice2, handPos);
    ...
    case tribute:
        playCard_Tribute(state, currentPlayer, nextPlayer, choice1, choice2, handPos);

    case ambassador:
        playCard_Ambassador(state, choice1, choice2, handPos, currentPlayer);
